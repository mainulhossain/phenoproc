...
class Action(object):
    ...
    def run_hdfs(workitem):
        ...
        runHadoop(os.path.abspath('mapper.py'), os.path.abspath('reducer.py'), os.path.join(input_datasource.url, workitem.inputs.url), os.path.join(output_datasource.url, workitem.outputs.url))
